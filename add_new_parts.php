  ...
  <li class="nav-item">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
<div class="container">
  <form action="insert_new_parts.php" method="post">
    <div class="row">
    <div class="col-sm-1">
  ...
  <div class="col-sm-2">
    ...
    <div class="col-sm-2">
    <div class="form-group">
      <label for="estamt">Est Amt:</label>
      <input type="text" class="form-control" id="estamt" name="Est_Amt">
    </div>
  </div>
  <div class="col-sm-2">
    <div class="form-group">
      <label for="vndamt">Vnd Amt:</label>
      <input type="text" class="form-control" id="vndamt" name="Vnd_Amt">
    </div>
  </div>
