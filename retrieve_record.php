  ...
  <li class="nav-item">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
              ...
              <form role="form" action="retrieve_record.php" method="post">
                    <div class="form-group mb-3">
                        <div class="row">
                            <div class="col-sm-4">
                        <label for="license">Enter License Plate</label>
                         <input id="lic" class="form-control" type="text" name="license">
                            </div>
...
if (isset($_POST["license"])) {
  ...
  if (count($results) > 0) { foreach ($results as $r) {
    ...
    printf("<div>%s", $r["License_Plate"]);
    printf("<div>%s", $r["VIN"]);
    printf("<div>%s", $r["Car_Name"]);
    printf("<div>%s", $r["Customer_Name"]);
    printf("<div>%s", $r["Insurance"]);
    printf("<div>%s", $r["Claim_Number"]);
    printf("<div>%s", $r["In_Date"]);
    printf("<div>%s", $r["Out_Date"]);
    printf("<div>%s", $r["All_Parts_Here"]);
